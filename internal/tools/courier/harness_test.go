...
// capturedRequest records what the fake Courier server saw.
...
// run executes one courier subcommand against the fake server and returns the
// exit code plus captured stdout/stderr. The API key is always injected.
