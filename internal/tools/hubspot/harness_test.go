...
// capturedRequest records what the fake HubSpot server saw.
...
// runResult constructs the service pointed at the fake server and runs one
// command with a seeded access token, returning the outcome and captured output.
...
// run is runResult reduced to the exit code plus streams.
