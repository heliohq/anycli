...
func TestSideEffectAnnotations(t *testing.T) {
	want := map[string]string{
		"contacts list":         "false", // GET /people/me/connections
		"contacts get":          "false", // GET /people/{id} or /people:batchGet
		"contacts search":       "false", // GET /people:searchContacts (warmup is also GET)
		"contacts other list":   "false", // GET /otherContacts
		"contacts other search": "false", // GET /otherContacts:search
		"contacts groups list":  "false", // GET /contactGroups
		"contacts groups get":   "false", // GET /contactGroups/{id}
		"contacts resolve":      "false", // synthetic verb over the GET search endpoints
	}
