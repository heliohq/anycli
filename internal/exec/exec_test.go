...
func (r fixedResolver) Resolve(ctx context.Context, tool credential.Tool) (*credential.Credential, error) {
...
func (nilResolver) Resolve(ctx context.Context, tool credential.Tool) (*credential.Credential, error) {
	return nil, nil
}
